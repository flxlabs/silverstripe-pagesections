		...
		$(".ss-gridfield-pagesections tbody").entwine({
			...
			onadd: function () {
				...
				this.find("tr.ss-gridfield-item").each(function () {
					...
					/*$this.after("<tr class='pagesections-droprow'>" +
						"<td class='col-treenav' colspan='999'></td></tr>");*/
					...
					$this.draggable({
						...
						start: function () {
							...
							$(".ui-droppable").each(function () {
								...
								if ($tr.data("id") == $this.data("id") &&
									$treenav.siblings(".col-reorder").data("sort") == $this.find(".col-reorder").data("sort") &&
									$treenav.data("parent") == $this.find(".col-treenav").data("parent")) {
									return;
								}
								...
								if (
									...
									if (!$this.find(".col-treenav").data("allowed-root")) {
										return;
									}
								}
